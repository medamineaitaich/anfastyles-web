            ...
            <div className="order-2 space-y-6 lg:order-1">
              ...
              <div className="flex flex-wrap gap-2">
                {TRUST_BADGES.map((badge) => (
                  <div key={badge} className="rounded-full bg-background/70 px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-foreground shadow-sm ring-1 ring-border/40">
                    {badge}
                  </div>
                ))}
              </div>
                ...
                return (
                  ...
                  >
                    <div className="relative">
                      <img
                        src={image.src}
                        alt={`${image.label} Compost T-Shirt`}
